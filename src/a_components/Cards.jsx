...
const Cards = () => {
  const CARD_IMG =
    "https://images.unsplash.com/photo-1508780709619-79562169bc64?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fHRlY2h8ZW58MHx8MHx8fDA%3D";
  ...
  return (
    <div className="card">
      ...
      <div className="box">
        ...
        <Link to={"/description"}>
          <p>Описание услуги тд тп текс потом</p>
        </Link>
        <div className="views">
          <img src={eye} alt="" />
          <h6>1234</h6>
